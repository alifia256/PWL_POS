...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-striped table-hover table-sm" id="table_supplier">
            <thead>
                <tr>
                    <th>No</th><th>Kode Supplier</th><th>Nama Supplier</th><th>Alamat Supplier</th><th>Aksi</th>
                </tr>
            </thead>
        </table>
    </div>
...
<script>
    $(document).ready(function () {
        var dataTable = $('#table_supplier').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
            ...
            columns: [
                ...
                {data: 'aksi', className: 'aksi', orderable: false, searchable: false},
            ]
        });
    });
</script>
