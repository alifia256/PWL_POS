...
class SupplierController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($supplier)
            ...
            ->addColumn('aksi', function ($supplier) {
                ...
                $btn .= '<button type="submit" class="btn btn-danger btn-sm" onclick="return confirm
                (\'Apakah anda yakin menghapus data ini?\')">Hapus</button>';
                $btn .= '</form>';
                return $btn;
            })
            ->rawColumns(['aksi'])
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect('/supplier')->with('error', 'Data supplier tidak bisa dihapus karena terdapat data yang terkait');
        }
    }
}